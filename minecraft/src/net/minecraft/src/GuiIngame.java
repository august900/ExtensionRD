...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_F3)) {
			var8.drawStringWithShadow("Minecraft Alpha v1.14.06_01 (" + this.mc.debug + ")", 2, 2, 16777215);
			var8.drawStringWithShadow(this.mc.debugInfoRenders(), 2, 12, 16777215);
			var8.drawStringWithShadow(this.mc.getEntityDebug(), 2, 22, 16777215);
			var8.drawStringWithShadow(this.mc.debugInfoEntities(), 2, 32, 16777215);
			var8.drawStringWithShadow("Base version: Minecraft Alpha v1.1.2_01", 2, 42, 16777215);
			...
			var8.drawStringWithShadow("Minecraft Alpha v1.14.06_01", 2, 2, 16777215);
		}
