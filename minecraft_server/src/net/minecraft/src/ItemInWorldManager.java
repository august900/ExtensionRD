...
public class ItemInWorldManager {
	...
	public void onBlockClicked(int var1, int var2, int var3) {
		...
		if(var4 > 0 && this.removeProgress == 0.0F) {
			Block.canBlockGrass[var4].onBlockClicked(this.worldObj, var1, var2, var3, this.thisPlayer);
		}

		if(var4 > 0 && Block.canBlockGrass[var4].blockStrength(this.thisPlayer) >= 1.0F) {
	...
	public void updateBlockRemoving(int var1, int var2, int var3, int var4) {
		if(this.curBlockDurability > 0) {
			...
			if(var1 == this.posX && var2 == this.posY && var3 == this.posZ) {
				...
				Block var6 = Block.canBlockGrass[var5];
	...
	public boolean removeBlock(int var1, int var2, int var3) {
		Block var4 = Block.canBlockGrass[this.worldObj.getBlockId(var1, var2, var3)];
	...
	public boolean tryHarvestBlock(int var1, int var2, int var3) {
		...
		if(var6 && this.thisPlayer.canHarvestBlock(Block.canBlockGrass[var4])) {
			Block.canBlockGrass[var4].dropBlockAsItem(this.worldObj, var1, var2, var3, var5);
		}
