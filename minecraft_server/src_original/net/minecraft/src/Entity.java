...
public abstract class Entity {
		...
		if(this.noClip) {
			...
			if(this.canTriggerWalking) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && var27 > 0) {
					...
					StepSound var28 = Block.canBlockGrass[var27].stepSound;
					...
					} else if(!Block.canBlockGrass[var27].material.getIsLiquid()) {
						this.worldObj.playSoundAtEntity(this, var28.getStepSound(), var28.getVolume() * 0.15F, var28.getPitch());
					}

					Block.canBlockGrass[var27].onEntityWalking(this.worldObj, var36, var25, var38, this);
				}
			}
			...
			for(int var30 = var36; var30 <= var27; ++var30) {
				for(int var31 = var25; var31 <= var39; ++var31) {
					for(int var32 = var38; var32 <= var29; ++var32) {
						...
						if(var33 > 0) {
							Block.canBlockGrass[var33].onEntityCollidedWithBlock(this.worldObj, var30, var31, var32, this);
						}
					}
				}
			}
	...
	public boolean isInsideOfMaterial(Material var1) {
		...
		if(var7 != 0 && Block.canBlockGrass[var7].material == var1) {
